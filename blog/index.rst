...
Welcome to my blog, let :math:`\Sigma` be the set of the Unicode symbols, then this site
is a subset :math:`\mathbb{B} \subset \Sigma^*`. Assuming that your browser can parse and interprets :math:`\mathbb{B}`, and hoping that you find it more interesting than a generic subset, I wish you a pleasant navigation.
...
compared to what this blog looks like. However I'm more than this, I also appreciate a
variety of different things like cooking, `really nerd videogames`_, free software, music (light or classical, as a listener or as a player), sci-fi books, old and boring movies, etc...
